...
const Pw = () => {
    ...
    },[isEnglish, isNumber, isMoreThanEight, inputValue, isSpecialCharacter, inputCheck, state]);

    const handleColorChange = (action, isValid) => {
        switch (action) {
            case'English':  setIsEnglish(isValid)
                            break;
            case 'Number':  setIsNUmber(isValid)
                            break;
            case 'Eight':   setIsMoreThanEight(isValid)
                            break;
            case 'SpecialCharacter': setIsSpecialCharacter(isValid)
                                     break;              
        }
    };
