...
const MypageUserInfoTemplates = ({name, totalMoney}) => {
    ...
    const money = `${String(totalMoney)}원`
    ...
    return (
        <MypageUserInfoDiv>
            ...
            <div>
                ...
                <ImageText imageClassName="mypageMoneyIcon" divClassName="basic" text={money} src="images/coin.svg" alt="images/coin.svg" textClassName="mypageMoneyTotal" />
            </div>
        </MypageUserInfoDiv>
    );
};
